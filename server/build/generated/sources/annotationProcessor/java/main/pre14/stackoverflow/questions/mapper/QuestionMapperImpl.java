...
public class QuestionMapperImpl implements QuestionMapper {
    ...
    protected MemberDto.Response memberToResponse(Member member) {
        ...
        MemberDto.Response response = new MemberDto.Response( memberId, email, name, phone, roles, memberStatus, numberOfQuestions, numberOfAnswers );
    ...
    protected MemberDto.Response memberToResponse1(Member member) {
        ...
        numberOfQuestions = countNumberOfQuestions( member.getQuestions() );
        numberOfAnswers = countAnswers( member.getAnswers() );
        List<String> list = member.getRoles();
        if ( list != null ) {
            roles = new ArrayList<String>( list );
        }
